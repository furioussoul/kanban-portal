  ...
  return (
    <section id="features" className="container mx-auto px-4 py-24">
      ...
      <div className="grid grid-cols-1 md:grid-cols-12 gap-6">
        {/* Main Feature - Agent */}
        <div className="md:col-span-8 group relative overflow-hidden rounded-3xl border border-border bg-card p-8 hover:shadow-2xl transition-all duration-500">
        ...
        {/* Feature 2 - Kanban */}
        <div className="md:col-span-4 group relative overflow-hidden rounded-3xl border border-border bg-card p-8 hover:shadow-2xl transition-all duration-500">
        ...
        {/* Feature 3 - Ecosystem */}
        <div className="md:col-span-6 group relative overflow-hidden rounded-3xl border border-border bg-card p-8 hover:shadow-2xl transition-all duration-500">
...
> Generating PRs...`}
        ...
        <div className="md:col-span-6 group relative overflow-hidden rounded-3xl border border-border bg-gradient-to-br from-primary/10 via-background to-accent/10 p-8 hover:shadow-2xl transition-all duration-500">
